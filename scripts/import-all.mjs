...
import { parseGuides } from './parsers/guides-parser.mjs'
import { parseExperiences } from './parsers/experiences-parser.mjs'
import { parseDestinations } from './parsers/destinations-parser.mjs'

async function importAll() {
  console.log('🚀 Starting bulk content import...\n')
  console.log('This will import:')
  console.log('  - 7 Guides')
  console.log('  - 8 Experiences')
  console.log('  - 10 Destinations')
  console.log('\n⚠️  Note: Tours will be imported separately (see import-tours.mjs)\n')
  ...
  try {
    ...
    console.log('\n📝 Next steps:')
    console.log('  1. Run: node scripts/import-tours.mjs (to import all tours - coming soon)')
