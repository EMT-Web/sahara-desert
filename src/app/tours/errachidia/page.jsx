  ...
  return (
    <>
      ...
      <section className="relative h-72 md:h-[420px] flex items-end overflow-hidden">
        <Image src="/images/image00022.jpeg" alt="Sahara Desert tours from Errachidia" fill className="object-cover object-center" priority sizes="100vw" />
        ...
        <div className="relative container mx-auto px-4 pb-12">
          <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-white/50 text-xs mb-3">
            ...
            <span>/</span>
            <span className="text-white/70">Errachidia</span>
          </nav>
          <p className="text-xs font-semibold tracking-widest uppercase text-desert-300 mb-3">
            Departing from Errachidia
          </p>
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white">
            Sahara Desert Tours from Errachidia
          </h1>
          <p className="text-white/75 mt-3 text-lg max-w-2xl">
            The closest gateway to Erg Chebbi: gorges, oases, and golden dunes within reach in a single day
          </p>
        </div>
      </section>
      ...
      {/* Proximity callout */}
      <section className="bg-desert-700 text-white py-10">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-desert-200 text-sm font-semibold tracking-wide uppercase mb-2">Why Errachidia?</p>
            <p className="text-white/85 text-lg leading-relaxed">
              Errachidia is the closest major city to Erg Chebbi, just 80 km from Merzouga. Ideal for travellers who want to spend more time in the desert and less time on the road.
            </p>
          </div>
        </div>
      </section>
            ...
            <>
              <div className="mb-10">
                <h2 className="text-3xl font-serif font-bold text-gray-900 mb-2">
                  Available Tours from Errachidia
                </h2>
                <p className="text-gray-500">
                  {tours.length} {tours.length === 1 ? 'tour' : 'tours'} departing from Errachidia
                </p>
              </div>
            ...
            <div className="text-center py-20">
              <div className="bg-sand-50 rounded-2xl p-14 max-w-2xl mx-auto border border-sand-200">
                ...
                <p className="text-gray-900 leading-relaxed mb-8">
                  We are preparing our Errachidia departure tours. Contact us to plan a custom adventure in the meantime.
                </p>
      ...
      <section className="bg-sand-50 py-16 border-t border-sand-200">
        <div className="container mx-auto px-4">
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">Tips and stories about Erg Chebbi and the Errachidia region</p>
          </div>
      ...
      <section className="relative overflow-hidden">
        <Image src="/images/image00059.jpeg" alt="Sahara Desert landscape from Errachidia" fill className="object-cover" sizes="100vw" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-black/40" />
        <div className="relative container mx-auto px-4 py-24 flex flex-col items-center text-center text-white">
          <span className="text-xs font-semibold tracking-widest uppercase text-desert-300 mb-4">The Dunes Are Waiting</span>
          ...
          <p className="text-base md:text-lg text-white/75 mb-10 max-w-xl">
            No other city puts you closer to Erg Chebbi. From Errachidia, the dunes are already on the horizon.
          </p>
