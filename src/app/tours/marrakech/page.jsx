  ...
  return (
    <>
      ...
      <section className="relative h-72 md:h-[420px] flex items-end overflow-hidden">
        <Image src="/images/image00006.jpeg" alt="Sahara Desert tours from Marrakech" fill className="object-cover object-center" priority sizes="100vw" />
        ...
        <div className="relative container mx-auto px-4 pb-12">
          <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-white/50 text-xs mb-3">
            ...
            <span>/</span>
            <span className="text-white/70">Marrakech</span>
          </nav>
          ...
          <p className="text-white/75 mt-3 text-lg max-w-2xl">
            Cross the High Atlas, trace the Draa Valley, and arrive where the dunes rise above everything
          </p>
        </div>
      </section>
            ...
            <>
              <div className="mb-10">
                <h2 className="text-3xl font-serif font-bold text-gray-900 mb-2">
                  Available Tours from Marrakech
                </h2>
                <p className="text-gray-500">
                  {tours.length} {tours.length === 1 ? 'tour' : 'tours'} departing from Marrakech
                </p>
              </div>
            ...
            <div className="text-center py-20">
              <div className="bg-sand-50 rounded-2xl p-14 max-w-2xl mx-auto border border-sand-200">
                ...
                <p className="text-gray-900 leading-relaxed mb-8">
                  We are preparing our Marrakech departure tours. Contact us to plan a custom adventure in the meantime.
                </p>
      ...
      <section className="bg-sand-50 py-16 border-t border-sand-200">
        <div className="container mx-auto px-4">
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">Tips and stories to inspire your Marrakech desert journey</p>
          </div>
      ...
      <section className="relative overflow-hidden">
        <Image src="/images/image00001.jpeg" alt="Sahara Desert landscape from Marrakech" fill className="object-cover" sizes="100vw" />
        ...
        <div className="relative container mx-auto px-4 py-24 flex flex-col items-center text-center text-white">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-5 max-w-2xl leading-tight">
            Ready to Leave Marrakech Behind?
          </h2>
          <p className="text-base md:text-lg text-white/75 mb-10 max-w-xl">
            The Sahara is calling. Let our Berber guides take you from the medina to the most spectacular dunes on earth.
          </p>
